...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    ROS_INFO("Topic: %s", chatter_pub.getTopic().c_str());
    ROS_INFO("NumSubscribers: %d", chatter_pub.getNumSubscribers());
    ROS_INFO("isLatched: %s", chatter_pub.isLatched()?"true":"false");
